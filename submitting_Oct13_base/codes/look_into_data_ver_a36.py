...
from interval import (
        save_table_of_intervals, 
        save_plot_of_intervals_of_basic_traits, 
        save_plot_of_intervals_of_binary_traits, 
        )
"""
python ./look_into_data_ver_${ver}.py \
    --function save_table_of_intervals_of_seven_basic_traits \
    --in_file_path "./datasets/case_master.tsv" \
    --out_file_path "./datasets/intervals_of_seven.tsv" \
    --mode "seven" \

python ./look_into_data_ver_${ver}.py \
    --function save_plot_of_intervals_of_basic_traits \
    --in_file_path "./datasets/intervals_of_seven.tsv" \
    --out_file_path "./datasets/intervals_of_seven.pdf" \


python ./look_into_data_ver_${ver}.py \
    --function save_table_of_intervals \
    --in_file_path "./datasets/case_master_with_binary_traits_out_of_seven.tsv" \
    --out_file_path "./datasets/intervals_of_binary.tsv" \
    --mode "binary" \

function plot_binary_intervals () {
    local operator=${1}
    python ./look_into_data_ver_${ver}.py \
        --function save_plot_of_intervals_of_binary_traits \
        --in_file_path "./datasets/intervals_of_binary.tsv" \
        --out_file_path "./datasets/intervals_of_binary_of_${operator}.pdf" \
        --mode "${operator}" \

}
plot_binary_intervals "plus"
plot_binary_intervals "minus"
plot_binary_intervals "over"
